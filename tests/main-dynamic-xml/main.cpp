...
int main(int argc, char *argv[]) {
    ...
    configurationFileParams confFileParameters;
    confFileParameters.size = sizeof(configurationFileParams);
    confFileParameters.fileType = XMLFileType;
    configurationXMLFileParams params = {"foo/traces",'/'};
    confFileParameters.params.XMLFile = &params;
    //struct rusage used;
    ...
    error = openLoggerFromConfigurationFileEx(&confFileParameters,"dynamicLogger.xml",&configuration,&debugFlags.mask);
    if (argc > 1) {
        n = atoi(argv[1]);
    }
