...
#define TRACE_FCT_CALL traceFunctionCall<debugLogger,char,traceFunctionCallStdStringPtrPolicy<char> > f(logDebug,__FUNCTION__,((debugFlags.mask &  MODULE_FLAG)!=0x0))
